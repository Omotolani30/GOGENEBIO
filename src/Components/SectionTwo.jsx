...
const SectionTwo = () => {
  return (
    <div className="flex justify-around items-center bg-[#4b066219] px-10 md:px-20 py-10 md:flex-row flex-col gap-10">
      <div>
      ...
      <div>
        <h1 className="font-bold text-4xl text-orange-600">120+</h1>
